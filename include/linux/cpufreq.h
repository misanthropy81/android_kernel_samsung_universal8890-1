...
#endif
#ifdef CONFIG_CPU_FREQ_GOV_SECACTIVE
extern unsigned int cpufreq_secactive_get_hispeed_freq(int cpu);
#endif
...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SECACTIVE)
extern struct cpufreq_governor cpufreq_gov_secactive;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_secactive)
#endif
